...
const AppAIContest = () => {
  ...
  const reportData = {
    ...
    body: [
      [
        'Problem Solving',
        ['分析問題找出癥結', '尋找各種選擇與替代方案', '妥善運用解決問題的技巧'],
        [4, 2, 1],
        '',
      ],
      [
        'Proactiveness',
        ['積極主動尋找解決問題的方法', '主動採取行動達成目標', '對挑戰積極主動處理'],
        [4, 3, 2],
        '',
      ],
      [
      ...
      [
        'Learning Agility',
        ['積極學習新技術', '舉一反三', '透過觀察學習', '可快速應用新知識'],
        [4, 2, 3, 4],
        '',
      ],
      [
        'Innovation',
        ['產生創意的想法和解決方案', '接納新方法和科技', '實施新方法改進流程'],
        [4, 3, 2],
        '',
      ],
      [
        'Collaboration',
        ['團隊合作達成共同目標', '積極參與和貢獻', '建立和諧的工作關係'],
        [4, 3, 4],
        '',
      ],
      ...
      [
        'Decision Making',
        ['做出明智和及時的決策', '考慮所有相關因素後做決定', '對決策結果負責'],
        [4, 4, 4],
        '',
      ],
    ...
    <>
      ...
      >
        ...
        <ModalContent>
          ...
          <ModalBody>
            <Box mb="4x">
              The interviewee's voice input is instantly transcribed to text and displayed here...
            </Box>
